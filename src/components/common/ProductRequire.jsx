      ...
      <div className="flex flex-col p-8 md:px-12 antialiased container mx-auto lg:max-w-4xl xl:max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row justify-between px-3 md:pt-2">
          ...
          <p className="text-sm md:text-md lg:text-xl pt-1 font-bold tracking-wide text-regular-theme">
            Budget ${product.estimated_budget}
          </p>
        </div>
        ...
        <div className="flex flex-col border border-white shadow-xl my-6 p-6">
          ...
          />
          <input
            className="border  lg:overflow-hidden placeholder-black text-md leading-relaxed tracking-wide my-4 p-4  border-regular-theme flex flex-col break-all"
            type="number"
        ...
        <div className="">
          <button
            className="text-left text-white tracking-wide text-sm lg:text-md font-semibold bg-light-theme px-8 lg:px-16 py-3 lg:py-3 hover:bg-regular-theme  "
