    ...
    <section className="relative antialiased pb-12 md:pb-0 flex flex-col  w-full min-h-screen">
      ...
      <div className="container md:px-8 lg:px-16 mx-auto">
        ...
        <div className="flex relative z-10 flex-col md:flex-row mt-8 md:mt-20 justify-center lg:justify-between items-center md:space-x-6 xl:space-x-0   space-y-6 md:space-y-0 ">
          {/* 1st row */}
          <div className=" border-t-8 lg:flex lg:justify-between lg:flex-col lg:p-8  border-opacity-70 border-l-8 p-7 bg-extra-light bg-opacity-80 bg-clip-padding w-4/5 md:w-3/6  xl:w-96 lg:h-72 xl:h-80  h-80  rounded-xl border-light-theme">
          ...
          <div className=" border-t-8 lg:flex lg:justify-between lg:flex-col lg:p-8  border-opacity-70 border-l-8 p-7 bg-extra-light bg-opacity-80 bg-clip-padding w-4/5 md:w-3/6  lg:h-72  xl:w-96  h-80  xl:h-80 rounded-xl border-light-theme">
            <h1 className="text-xl font-semibold lg:font-bold leading-7 tracking-wide ">
              Submit your product requirements and get proposals. Find the best
              deals now
            </h1>
          ...
          <div className=" border-t-8 lg:flex lg:justify-between lg:flex-col lg:p-8  border-opacity-70 border-l-8 p-7 bg-extra-light bg-opacity-80 bg-clip-padding w-4/5 md:w-3/6  lg:h-72  xl:w-96 xl:h-80  h-80  rounded-xl border-light-theme">
            <h1 className="text-xl font-semibold lg:font-bold leading-7 tracking-wide ">
              Submit your product requirements and get proposals. Find the best
              deals now
            </h1>
